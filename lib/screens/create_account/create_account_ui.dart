...
class CreateAccount extends StatefulWidget {
  static const String routeName = "create Acount Screen";
...
class _CreateAccountState
    extends BaseView<CreateAccountViewModel, CreateAccount>
  ...
  void createAccount() async {
    if (formKey.currentState!.validate()) {
      viewModel.createAccount(
          emailCont.text, passwordCont.text, usernameCont.text);
    }
  }
